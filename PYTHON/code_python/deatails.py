...
class DeatailsRoom:
    def __init__(self,root):
		...
		#============labelFrame===========
        labelframeleft=LabelFrame(self.root,relief=RIDGE,text="New Room Add",font=("times new roman",12,"bold"),padx=2)
        ...
        entry_floor=ttk.Entry(labelframeleft,textvariable=self.var_floor,font=("arial",13,"bold"),width=29)
        entry_floor.grid(row=0,column=1, sticky=W)
        
        # Room No
        lbl_RoomNo=Label(labelframeleft,text="Room No" ,font=("arial",12,"bold"),padx=2,pady=6)
        lbl_RoomNo.grid(row=1,column=1,sticky=W,padx=20)
...
#fectch data
    def fetch_data(self):
            conn=mysql.connector.connect(host="localhost",username="root",password="Test@123", database="management")
            my_cursor=conn.cursor()
            my_cursor.execute("select * form details") 
    ...
    def mDelete(self):
        ...
        if mDelete>0:
            conn=mysql.connector.connect(host="localhost",username="root",password="Test@123", database="management")
            my_cursor=conn.cursor()
            query="delete form details where RoomNo=%s"
