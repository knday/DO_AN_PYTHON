...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        #===========1st img=============
        img1=Image.open("C:\KIM NGỌC\PYTHON\hotel images\hotel1.png")
        ...
        #===========right side image=========
        img3=Image.open("C:\KIM NGỌC\PYTHON\hotel images\slide3.jpg")
        ...
        #=============down images=========
        img4=Image.open("C:\KIM NGỌC\PYTHON\hotel images\myh.jpg")
        ...
        img5=Image.open("C:\KIM NGỌC\PYTHON\hotel images\khana.jpg")
    ...
    # Đã di chuyển phương thức cust_details vào
